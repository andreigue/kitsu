export default {
  ...
  people: {
    ...
    fields: {
      ...
      telegram_chat_id_placeholder: 'Enter your Telegram chat ID (e.g., 123456789)',
      position: 'Position',
      role: 'Role',
      seniority: 'Seniority',
      studio: 'Studio'
  ...
  profile: {
    ...
    notifications_telegram_enabled: 'Telegram notifications enabled',
    notifications_telegram_chat_id: 'Telegram Chat ID',
    notifications_telegram_chat_id_placeholder: 'Enter your Telegram chat ID (e.g., 123456789)',
